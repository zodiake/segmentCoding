 ...
 */
public class StandardWithNoNumberAnalyzer extends StopwordAnalyzerBase {
     ...
     */
    public StandardWithNoNumberAnalyzer() {
     ...
     */
    public StandardWithNoNumberAnalyzer(CharArraySet stopwords) {
        super(stopwords);
    }
